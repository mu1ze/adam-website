...
- Name: games.spec.ts >> Games >> flappy-bird — start button works
- Location: tests/games.spec.ts:41:9

# Error details

```
Error: page.goto: net::ERR_ABORTED at http://127.0.0.1:3369/games/flappy-bird
Call log:
